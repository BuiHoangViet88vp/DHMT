...
void oto1() {
	mat4 vitri = Translate(0.2, 0.18, -0.15);
...
void oto2() {
	mat4 vitri = Translate(0.7, 0.18, -0.15);
	mat4 thunho = vitri * Scale(0.5, 0.5, 0.5);
	ctm_oto = thunho * RotateX(Theta[6]);
	banh(0, 0, 0);
	banh(0.25, 0, 0);
...
void oto3() {
	mat4 vitri = Translate(0.7, 1.05, -0.15);
	mat4 thunho = vitri * Scale(0.5, 0.5, 0.5);
	ctm_oto = thunho * RotateX(Theta[6]);
	banh(0, 0, 0);
	banh(0.25, 0, 0);
...
void oto4() {
	mat4 vitri = Translate(0.2, 1.05, -0.15);
	mat4 thunho = vitri * Scale(0.5, 0.5, 0.5);
	ctm_oto = thunho * RotateX(Theta[6]);
	banh(0, 0, 0);
	banh(0.25, 0, 0);
...
void tu() {
	mat4 vitri = Translate(0, 0.5, 1.5);
...
void tu2() {
	mat4 vitri = Translate(-0.7, 0.5, 1.5);
	ctm_tu = vitri * RotateY(Theta[2]);
	mattraitu(0, 0, 0);
	mattraitu(0.6, 0, 0);
	mattraitu(0.3, 0, 0);
...
void fan_display() {
	setMau(0.4, 0.1, 0.01);
	mat4 instance = Translate(0, 2, 0.08);
	glUniformMatrix4fv(model_loc, 1, GL_TRUE, instance * Scale(0.1, 0.3, 0.1));
	glDrawArrays(GL_TRIANGLES, 0, NumPoints);
	...
	setMau(0.01, 0.5, 0.9);
	float scale = 0.4;
	instance = Translate(cos(fanRotate * DegreesToRadians) * scale, 2, sin(fanRotate * DegreesToRadians) * scale) * RotateY(-fanRotate);
	glUniformMatrix4fv(model_loc, 1, GL_TRUE, instance * Scale(1, 0.15, 0.1));
	glDrawArrays(GL_TRIANGLES, 0, NumPoints);

	GLfloat fanRotate1 = fanRotate + 90;
	instance = Translate(cos(fanRotate1 * DegreesToRadians) * scale, 2, sin(fanRotate1 * DegreesToRadians) * scale) * RotateY(-fanRotate1);
	glUniformMatrix4fv(model_loc, 1, GL_TRUE, instance * Scale(1, 0.15, 0.1));
	glDrawArrays(GL_TRIANGLES, 0, NumPoints);
